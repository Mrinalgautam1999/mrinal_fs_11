...
public class MailHandler {
    ...
    public static void sendMail()
    {
        ...
        try {
            mailMessage.setFrom("mmrinalgautam1999@gmailcom");
            mailMessage.setSubject("Geekster_Test");
            mailMessage.setRecipient(Message.RecipientType.TO, new InternetAddress("mmrinalgautam1999@gmail.com"));
